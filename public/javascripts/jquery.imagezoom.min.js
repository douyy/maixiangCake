(function($){$.fn.imagezoom=function(options){var settings={xzoom:418,yzoom:398,offset:10,position:"BTR",preload:1};if(options){$.extend(settings,options);}
...
$("div.zoomDiv").css({top:boxTop,left:leftpos-9});$("div.zoomDiv").width(settings.xzoom);$("div.zoomDiv").height(settings.yzoom);$("div.zoomDiv").show();$(this).css('cursor','crosshair');$(document.body).mousemove(function(e){mouse=new MouseEvent(e);if(mouse.x<imageLeft||mouse.x>imageLeft+imageWidth||mouse.y<imageTop||mouse.y>imageTop+imageHeight){mouseOutImage();return;}
